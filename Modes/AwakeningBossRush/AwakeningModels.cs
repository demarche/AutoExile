...
public enum AwakeningPhase { Dormant, Prepare, IndexStash, Withdraw, OpenMap, EnterPortal, Scout, Fight, Loot, MapBoss, Return, OpenStash, ExternalStash, AwaitingReview, Stopped, RestockMap, Restock, MarketBuy }
